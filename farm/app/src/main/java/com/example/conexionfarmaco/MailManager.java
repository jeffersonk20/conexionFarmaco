...
public class MailManager extends AsyncTask<Void, Void, Void> {
    ...
    private static final String PASSWORD = "birv pbgy jrik hzgu"; // Contraseña de aplicación
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            message.setSubject("🏥 ¡Bienvenido/a a Conexión Fármaco!");
            
            String htmlContent = "<div style='font-family: Arial, sans-serif; color: #2E4053; border: 1px solid #D6EAF8; padding: 20px; border-radius: 10px;'>" +
